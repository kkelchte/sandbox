...
# Settings:
LAUNCHFILE="ba_corridor.launch"
WORLD_DIR="esat_corridor"
MODELDIR="2017-03-24_1731" #"feat_depth_offpol/2017-03-30_1335" #"2017-03-24_1731"
...
TAG="feat_depth_offpol" #"wd_$WEIGHT_DECAY-bs_$BUFFER_SIZE"
mkdir -p /home/klaas/tensorflow2/log/$TAG
LOGDIR="$TAG/$(date +%F_%H%M)"
# Depth input with fc control:
# Normal network:
PARAMS="--owr True --off_policy True --auxiliary_depth True"

...
MODELDIR="depth_control_100_ep_alpha_drop/2017-03-22_1414" #"2017-03-10_0957_esat_offline_7" 
...
PARAMS="--evaluate True --depth_input True --network fc_control --continue_training True --speed 1.8" # --save_activations True 

...
echo "python main.py --launch_ros False --log_tag $1 --checkpoint_path $2 --continue_training True --learning_rate $3 --weight_decay $4"
python main.py --launch_ros False --log_tag $1 --checkpoint_path $2 --continue_training True --learning_rate $3 --weight_decay $4
